...
const ModalObservacion = ({ open, handleClose, control, agregarObservacion, errors }: Props) => {
  return (
    <Dialog
      open={open}
      ...
      <DialogContent>
        <div className="flex flex-col gap-2">
          <div className="flex gap-3">
            ...
            <Button className="h-[33px]" variant="contained" onClick={agregarObservacion}>
              Agregar
            </Button>
          </div>
          <div className="w-full">
            <Button className="w-full" variant="contained" color="error" onClick={handleClose}>
              Cancelar
            </Button>
          </div>
        </div>
