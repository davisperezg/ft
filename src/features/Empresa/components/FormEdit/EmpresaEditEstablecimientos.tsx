            ...
            <fieldset className="w-full border rounded-sm p-[8px] mb-2 relative">
              ...
              <div className="w-full flex flex-row gap-2 mb-2">
                ...
                <div className="flex w-1/2">
                  <div className="w-1/3">
                    <label>
                      Denominacion: <strong className="text-danger">*</strong>
                    </label>
                  </div>
                  <div className="w-2/3">
                    <Controller
              ...
              <div className="w-full flex flex-row gap-2 mb-2">
                <div className="flex w-1/3">
                  <div className="w-1/3">
                    <label>
                      Departamento: <strong className="text-danger">*</strong>
                    </label>
                  </div>
                  <div className="w-2/3">
                    <Controller
                ...
                <div className="flex w-1/3">
                  <div className="w-1/3">
                    <label>
                      Provincia: <strong className="text-danger">*</strong>
                    </label>
                  </div>
                  <div className="w-2/3">
                    <Controller
                ...
                <div className="flex w-1/3">
                  <div className="w-1/3">
                    <label>
                      Distrito: <strong className="text-danger">*</strong>
                    </label>
                  </div>
                  <div className="w-2/3">
                    <Controller
              ...
              <div className="w-full flex flex-row gap-2 mb-2">
                <div className="flex w-1/2">
                  <div className="w-1/3">
                    <label>
                      Direccion: <strong className="text-danger">*</strong>
                    </label>
                  </div>
                  <div className="w-2/3">
                    <Controller
